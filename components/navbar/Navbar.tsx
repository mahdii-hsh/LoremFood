...
export default function Navbar() {
  ...
  const scrollPageToSubscribeSection = () => {
    const element = document.getElementById("subcribe-section");
      ...
      <div className="grid grid-cols-12 bg-amber-50 h-full text-slate-800 rounded-2xl">
        ...
        <div className="hidden lg:col-span-5 lg:flex items-center text-lg justify-center lg:gap-x-2">
          ...
          <div
            ...
            onClick={scrollPageToSubscribeSection}
          >
            تماس با ما
          </div>
          <div>|</div>
        ...
        <div className="col-span-7 sm:col-span-8 lg:col-span-4  flex items-center justify-end pe-5 sm:pe-10 lg:pe-0 lg:justify-center gap-x-1 md:gap-x-3">
          {getThemeIcon()}
          <Link href="/login">
            <User className="size-6 bg-amber-100 2xl:size-10 rounded-full hover:scale-110 duration-300 delay-150 2xl:p-2 stroke-slate-800 cursor-pointer " />
          </Link>
