  ...
  return (
    <div className="grid grid-cols-12 px-12">
      ...
      <div className="col-start-4 col-span-6 2xl:col-start-4 2xl:col-span-6 px-10 my-8 2xl:px-10 2xl:my-8">
        <button
          type="submit"
          className="w-full h-10 2xl:w-full 2xl:h-10 2xl:px-4 bg-amber-100 rounded-2xl font-prj font-medium text-amber-800 cursor-pointer transition-all hover:scale-95"
        >
          ثبت درخواست
        </button>
      </div>
